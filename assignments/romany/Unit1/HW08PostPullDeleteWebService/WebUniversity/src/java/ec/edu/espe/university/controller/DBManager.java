...
public class DBManager {
    ...
    public Instructor retrieve(int idPatient) {
     ...
     public Document generateDocument(Instructor instructor) {
        Document admin;
     ...
     public void deletePatient(Instructor oldPatient) {

        try {

            Document findDocument = generateDocument(oldPatient);
            collection.findOneAndDelete(findDocument);
        } catch (Exception e) {
        }
    }
     
    public Instructor update(int id, Instructor newInstructor) {
        Instructor oldInstructor = this.retrieve(id);
        try {

            Document findDocument = generateDocument(oldInstructor);
            Document updateDocument = generateDocument(newInstructor);
