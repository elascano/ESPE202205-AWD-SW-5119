...
include ('conexionS.php');
    ...
    if (isset($_POST['ingresar'])){
        ...
        $query = "INSERT INTO `usuario`(`nombre`, `apellido`, `cedula`, `user`, `clave`, `correo`,`curso`, `rol`, `area`, `nivel`) VALUES ('$nombre', '$apellido', '$cedula', '$user','$clave_cifrada','$correo', 'N/A','Supervisor','N/A','N/A')";
