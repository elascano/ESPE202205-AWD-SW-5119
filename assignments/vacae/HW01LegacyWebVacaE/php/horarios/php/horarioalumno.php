...
$nombreServidor = "localhost";
  ...
  $consultah=mysqli_query($conn,"SELECT hor_codigo from horarios where hor_nivel ='$nivel' and hor_paralelo = '$paralelo'");
  $h=mysqli_fetch_assoc($consultah);
  $id = $h["hor_codigo"];
  ...
  <table cellpadding="10" cellspacing="1">
      <thead>
          <tr>
              ...
              <th><strong>Profesor Asignado</strong></th>
          </tr>
      </thead>
      <tbody>
<?php
...
<div id="toys-grid" > <h3>HORARIO DEL ALUMNO</h3><br>
