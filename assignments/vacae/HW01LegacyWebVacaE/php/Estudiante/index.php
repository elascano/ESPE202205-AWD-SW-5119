...
<body id="portada">
	<header>
		<div class="contenedor"><h2 class="logotipo"><i class="fas fa-user-graduate" style="margin-right: 10px;"></i>Estudiante</h2>
	...
	<div class="vertical-menu">
        ...
        <ul id="respMenu" class="ace-responsive-menu" data-menu-style="accordion" style="border-top: 2px solid #FF5737;border-right: 2px solid #FF5737;background: #F5F5F5;">
			...
			<span class="arrow"></span> 
                ...
                <ul>
                    <li>
                        <a href="../horarios/php/horarioalumno.php" target="frame">
