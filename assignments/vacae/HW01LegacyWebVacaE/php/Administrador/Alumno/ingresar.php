...
$clave_cifrada = password_hash($clave,PASSWORD_DEFAULT);
        $query = "INSERT INTO `usuario`(`nombre`, `apellido`, `cedula`, `user`, `clave`, `correo`,`curso`, `rol`, `area`, `nivel`) VALUES ('$nombre', '$apellido', '$cedula', '$user','$clave_cifrada','$correo', '$curso','Alumno','N/A','$nivel')";
