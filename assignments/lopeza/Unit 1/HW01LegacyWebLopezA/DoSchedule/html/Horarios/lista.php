  ...
  <body>
    ...
    <div id="menu" class="col-md-12 text-right">
      <div class="container">
          ...
          <a class="btn btn-warning" href="horariosEst.php"><i class="fa fa-calendar-check-o"></i> Nuevo Horario</a>
      </div>
    </div>
    <!-- menu -->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <select id="nametask" class="form-control">
        <?php
          $query = $mysqli -> query ("SELECT * FROM registro_docentes WHERE do_tipo='Docente'");
          while ($valores = mysqli_fetch_array($query)) {
            echo '<option value="'.$valores[do_materia].' - '.$valores[do_nombres].'  '.$valores[do_apellidos].'">'.$valores[do_materia].' - '.$valores[do_nombres].'  '.$valores[do_apellidos].'</option>';
          }
        ?>
           </select>
