            ...
            {/* <main> */}
                ...
                <div className="main-hero--information"> 
                    ...
                    {/* <div className="hero--container">
                        <Link className="hero--container-buttons" to='/articulos'>Vender Artículos</Link>
                        <Link className="hero--container-buttons" to='/articulos'>Comprar Artículos</Link>
                    </div> */}
                </div>
                <section>
                    <div className="items--container">
                        <h3>Más de 12 895 artículos</h3>
