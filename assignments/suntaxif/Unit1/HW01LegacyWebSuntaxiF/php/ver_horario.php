...
<body>
  ...
  <div class="div_principal">
	...
	<div class="text-center">
		<a href="acciones_BD.php?action=modificar-horario&curso=<?php echo $_POST['curso'] ?>"><input type="button" class="btn btn-primary" value="Modificar" id="modificar" name="modificar"></a>
		<a href="acciones_BD.php?action=eliminar-horario&curso=<?php echo $_POST['curso'] ?>"><input type="button" class="btn btn-danger" value="Eliminar" id="eliminar" name="eliminar"></a>
	</div>
