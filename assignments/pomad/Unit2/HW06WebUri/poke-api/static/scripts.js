...
function randomPokemon(){
    ...
    .then(function (pokemon) {
        ...
        document.getElementById("defense").innerHTML =  pokemon.defense +' | ' + pokemon.special_defense ;
        document.getElementById("attack").innerHTML =  pokemon.attack +' | ' + pokemon.special_attack ;
